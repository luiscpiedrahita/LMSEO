...
function entryFooterFunctionBlogs($attributes) {
    $attributes['class'] = $attributes['class'] . ' ' . 'py-5';
    return $attributes;
}
/**
        ...
        <main id="main" class="main" role="main">
            ...
            while ( have_posts() ) : the_post();
                ...
                <?php
                    ...
                    if ( ! empty( $prev_post ) ):
                ?>
                <a href="<?php echo get_permalink( $prev_post->ID ); ?>" class="col-lg-6 d-block py-5 home-button blue-button text-middle">
                    <?php echo apply_filters( 'the_title', $prev_post->post_title ); ?>
                </a>
                <?php endif;
                if ( ! empty( $next_post ) ):
                    ?>
                    <a href="<?php echo get_permalink( $next_post->ID ); ?>" class="col-lg-6 d-block py-5 home-button blue-button text-middle clipped">
