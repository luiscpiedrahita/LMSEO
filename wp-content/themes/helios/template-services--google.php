...
function ServicesJS() {
    wp_register_script('internal-services', get_stylesheet_directory_uri('bootstrap') . '/dist/internal/services/google/js/app.js', array(), '1.0', true);
    wp_enqueue_script('internal-services');
}
/** Add Services JS to website */
add_action('wp_enqueue_scripts', 'ServicesCSS');
function ServicesCSS() {
    wp_register_style('services-css', get_stylesheet_directory_uri() . '/dist/internal/services/google/style.css', array(), '1.0', 'all');
