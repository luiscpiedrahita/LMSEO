...
/*
Template Name: Services - Digital
*/
...
function ServicesJS_services_definition() {
    wp_register_script('internal-digital-services', get_stylesheet_directory_uri('bootstrap') . '/dist/internal/services/digital/js/app.js', array(), '1.0', true);
    wp_enqueue_script('internal-digital-services');
}
/** Add Services JS to website */
add_action('wp_enqueue_scripts', 'ServicesCSS_services_definition');
function ServicesCSS_services_definition() {
    wp_register_style('services-css', get_stylesheet_directory_uri() . '/dist/internal/services/digital/style.css', array(), '1.0', 'all');
...
function lmseo_do_post_title() {
    ...
    genesis_markup(
        [
            ...
            'context' => 'magicbox-2',
            'atts' => [
                'class' => 'magicbox magicbox-2 border-top border-start border-5 blue-bg m-0 p-0 p-lg-0',
                'data-aos' => "fade-down",
                'data-aos-delay' => "0",
            ],
            'echo'    => true,
    ...
    genesis_markup(
        [
            ...
            'context' => 'magicbox-5',
            'atts' => [
                'class' => 'magicbox magicbox-5 border border-end-0 border-5 p-0 p-lg-0',
                'data-aos' => "fade-up",
                'data-aos-offset' => "100",
            ],
            'echo'    => true,
    ...
    genesis_markup(
        [
            ...
            'context' => 'magicbox-3',
            'atts' => [
                'class' => 'magicbox magicbox-3 gray-1-bg m-0 p-0 p-lg-0',
                'data-aos' => "fade-up",
                'data-aos-delay' => "0",
            ],
            'echo'    => true,
    ...
    $img = genesis_get_image(
        [
            'format'  => 'html',
            'size'    => 'full',
            'context' => 'magicbox-image',
            'attr'    => genesis_parse_attr('magicbox-image', ['class' => 'magicbox-image']),
        ]
    );
    if (! empty($img)) {
        genesis_markup(
            [
                ...
                'content' => $img,
                'context' => 'magicbox-7',
                'atts' => genesis_parse_attr('magicbox-7', ['class' => 'magicbox-7 border-top border-start border-bottom border-5', 'data-aos' => "fade-left",]),
            ]
        );
    }
    genesis_markup(
        [
            ...
            'context' => 'magicbox-4',
            'atts' => [
                'class' => 'magicbox-4 border-top border-start border-5 m-0 p-0 p-lg-0',
                'data-aos' => "fade-down",
                'data-aos-delay' => "0",
            ],
            'echo'    => true,
...
function lmseo_do_post_content() {
    genesis_markup(
        [
            ...
            'context' => 'services-digital-content',
            'atts' => genesis_parse_attr('services-digital-content', ['class' => 'services-digital-content']),
        ]
    );
}
