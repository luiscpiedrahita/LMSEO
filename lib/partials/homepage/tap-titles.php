...
$out .= '<section class="tab-titles container-fluid g-0">
  <div class="icon-bar five-up">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
        ...
        <label><span class="d-none d-md-block title-overflow-text">Recent</span> Posts</label>
      </a>
      ...
      <a class="item" href="#contact" onclick="javascript:void(0);$.scrollTo(\'#contact\', 1200);">
        ...
        <label>Contact <span class="d-none d-md-block title-overflow-text">Us</span></label>
      </a>
  </div>
</section>';
